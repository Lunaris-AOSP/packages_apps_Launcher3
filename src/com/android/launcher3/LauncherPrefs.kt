...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val OVERVIEW_GESTURE_PORTRAIT_PROGRESS = backedUpItem("pref_start_freeform_progress", 20)
        @JvmField val OVERVIEW_GESTURE_LANDSCAPE_PROGRESS = backedUpItem("pref_start_freeform_landscape_progress", 40)
